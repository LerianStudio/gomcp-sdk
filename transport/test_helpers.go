...
func (tc *TestCertificates) WriteCertificatesToFiles(dir string) (caCertFile, caKeyFile, serverCertFile, serverKeyFile, clientCertFile, clientKeyFile string, err error) {
	...
	if err = os.WriteFile(caCertFile, tc.CAPEMCert, 0600); err != nil {
	...
	if err = os.WriteFile(serverCertFile, tc.ServerPEMCert, 0600); err != nil {
	...
	if err = os.WriteFile(clientCertFile, tc.ClientPEMCert, 0600); err != nil {
